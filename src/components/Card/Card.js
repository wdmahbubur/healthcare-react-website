    ...
    return (
        <div className="shadow-lg px-4 py-6 border-2 border-gray-50 text-gray-700 hover:shadow-none transition-shadow duration-500">
            ...
            <div className="bottom-0">
                <Button type="button" customStyle="bg-blue-900 w-full" onClick={() => readMore(sid)}>Read More <FontAwesomeIcon icon={faArrowRight}></FontAwesomeIcon></Button>
            </div>
        </div>
    );
};
